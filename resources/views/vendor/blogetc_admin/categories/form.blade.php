...
<div class="form-group">
    <label for="category_category_name">Название категории</label>
...
<div class="form-group">
    ...
    <small id="category_slug_help" class="form-text text-muted">
        Допустимые символы: буквы, числа, знак подчеркивания.
        <!-- The slug
...
<div class="form-group">
    <label for="category_description">Описание категории (опционально)</label>
